...
// ✅ FIX: pehle yahan hardcoded tha "http://127.0.0.1:5000" — ye sirf
// tumhare apne computer pe kaam karta tha. Deploy hone ke baad frontend
// kabhi backend se baat nahi kar pata kyunki 127.0.0.1 sirf "khud ka computer"
// matlab hota hai, kisi aur ke browser mein.
//
// Ab: agar site localhost pe khul rahi hai (development), purana URL use hota hai.
// Warna (production mein), backend ka live URL use hoga.
//
// ⚠️ ZAROORI: jab backend (Render/Railway) deploy ho jaye, neeche
// "YOUR_BACKEND_URL_HERE" ko apne backend ke asli live URL se replace karo.
// Example: "https://fake-job-detection-api.onrender.com"
const PRODUCTION_API_URL = "https://fake-job-detection-7iq0.onrender.com";
